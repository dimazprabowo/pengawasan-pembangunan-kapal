...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => null,                                      // Will be set dynamically by LivewireConfigServiceProvider using system configuration
        'directory' => null,                                  // Example: 'tmp'                     | Default: 'livewire-tmp'
        'middleware' => [\App\Http\Middleware\TruncateLivewireUploadFilename::class, 'throttle:60,1'],
