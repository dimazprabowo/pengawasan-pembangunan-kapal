<div>
    ...
    <form wire:submit="save">
        ...
        {{-- Footer Actions --}}
        <div class="flex flex-col sm:flex-row items-center justify-end gap-3 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 px-5 py-4">
            <a href="{{ route('laporan-mingguan.index') }}" wire:navigate
                x-data="{ loading: false }" x-on:click="loading = true"
