    ...
    @if($laporan->tipe->value === 'harian')
        ...
        <div class="mb-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="p-6">
                ...
                @if($laporan->jenisKapal)
                    @if($laporan->jenisKapal->hasTemplate())
                        ...
                        <div class="flex items-center gap-2 flex-shrink-0">
                            @can('laporan_download')
                                <a href="{{ route('laporan.download-word', $laporan) }}"
                                    ...
                                    <span x-show="loading" x-cloak>Mengunduh...</span>
                                </a>
                            @endcan
                            @can('laporan_download')
                                <button wire:click="confirmDeleteDoc"
                                    ...
                                    <span wire:loading.remove wire:target="confirmDeleteDoc,deleteDoc">Hapus</span>
                                    <span wire:loading wire:target="confirmDeleteDoc,deleteDoc">Menghapus...</span>
                                </button>
                            @endcan
                        </div>
                    </div>
