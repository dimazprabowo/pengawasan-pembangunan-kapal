...
class KelembabanExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, ShouldAutoSize
{
    ...
    public function map($kelembaban): array
    {
        return [
            $kelembaban->nama,
            $kelembaban->nilai ?? '-',
            ...
            $kelembaban->created_at->format('d/m/Y H:i'),
        ];
    }
