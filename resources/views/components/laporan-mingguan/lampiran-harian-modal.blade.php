                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            @foreach($lampiranList as $item)
                                <div class="bg-white dark:bg-gray-700 border-2 {{ $item['is_selected'] ? 'border-green-500 dark:border-green-400' : 'border-gray-200 dark:border-gray-600' }} rounded-lg overflow-hidden hover:shadow-md transition-all relative cursor-pointer"
                                    ...
                                    {{-- Checkbox Badge --}}
                                    @if($item['is_selected'])
                                        <div class="absolute top-2 left-2 z-10 flex items-center justify-center w-6 h-6 bg-green-500 rounded-full shadow-lg">
                                            <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/>
                                            </svg>
                                        </div>
                                    @else
                                        <div class="absolute top-2 left-2 z-10 flex items-center justify-center w-6 h-6 bg-white dark:bg-gray-600 border-2 border-gray-300 dark:border-gray-500 rounded-full shadow">
                                        </div>
                                    @endif
                                    ...
                                    <div class="aspect-video bg-gray-100 dark:bg-gray-800 relative overflow-hidden group"
                                        ...
                                        <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all flex items-center justify-center opacity-0 group-hover:opacity-100">
                                            <button type="button" 
                                                ...
                                                class="px-3 py-1.5 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
