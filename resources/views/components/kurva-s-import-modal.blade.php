            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-2xl z-10">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <div wire:loading wire:target="kurvaS_file" class="absolute inset-0 bg-white/80 dark:bg-gray-800/80 rounded-lg flex items-center justify-center">
                                <div class="flex items-center justify-center h-full text-purple-600 dark:text-purple-400">
                ...
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 rounded-b-2xl flex items-center justify-end gap-3">
                    ...
                    <button 
                        ...
                        wire:target="importKurvaSTemplate,kurvaS_file"
                        type="button"
                        ...
                        <svg wire:loading.remove wire:target="importKurvaSTemplate,kurvaS_file" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"/>
                        </svg>
                        <svg wire:loading wire:target="importKurvaSTemplate,kurvaS_file" class="animate-spin w-4 h-4" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
                        <span wire:loading.remove wire:target="importKurvaSTemplate,kurvaS_file">Import</span>
                        <span wire:loading wire:target="importKurvaSTemplate,kurvaS_file">Loading...</span>
                    </button>
                </div>
            </div>
        </div>
